...
```  
The mean of the total number of steps taken per day is `r mn`.  
The median of the total number of steps taken per day is `r mdn`.
...
```    
The 5-minute interval that, on average across all the days, contains the maximum number of steps is `r max_interval`.
...
```{r,new_hist_total_steps_per_day}
...
```    
The mean total number of steps taken per day with missing data filled is `r mn_new`.  
The median total number of steps taken per day with missing data filled is `r mdn_new`.
